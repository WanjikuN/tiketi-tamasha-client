      ...
      <div className="container">
        ...
        <div className='about-image'>
          ...
          <section className="who-we-are">
            ...
            <p>With TIketi Tamasha, managing and controlling your online sales becomes a breeze. Our easy-to-use backend dashboard puts you in the driver's seat, allowing you to navigate and optimize your sales journey effortlessly. Let Tiketi Tamasha be the driving force behind your online success. Start your journey today!"</p>
          </section>
        </div>
      </div>
    </div>
